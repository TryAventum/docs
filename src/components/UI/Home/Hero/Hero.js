  ...
  return (
    ...
    >
      <div className="flex items-center flex-col text-center mb-6 md:p-8 md:w-1/2">
        <div className="w-1/2 hidden md:block animated  fadeInDown">
        ...
        <div className="flex items-center">
            <Button wrapperClass="animated fadeInLeft delay-1s" to="/docs/getting-started/installation/">
              Get Started
            </Button>
          <a className="ml-2 hover:text-brand-red animated fadeInRight delay-1s" href="#why">Why Aventum?</a>
        </div>
      </div>

      <div className="w-3/4 md:w-1/2 md:p-8">
        <img className="animated fadeInRight" src="/img/undraw_content_vbqo.svg" alt="Content" />
      </div>
    </div>
  )
}
